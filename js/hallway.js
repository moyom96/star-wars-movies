...
class Hallway{
	...
	constructor(width, height, depth, x, y, z, objects){
		...
		rightWall1.position.set(x + (depth / 2), height / 2, z + wallSize + 25); // First
		...
		rightWall2.position.set(x + (depth / 2), height / 2, z ); // Middle
		...
		rightWall3.position.set(x + (depth / 2), height / 2, z - wallSize - 25 ); // Last
		...
		leftWall1.position.set(x - (depth / 2), height / 2, z + wallSize + 25); // First
		leftWall1.rotation.y = Math.PI / 2;
		scene.add(leftWall1);
		objects.push(leftWall1);

		var leftWall2 = new THREE.Mesh( geometry, material );
		leftWall2.position.set(x - (depth / 2), height / 2, z - wallSize - 25); // Last
		leftWall2.rotation.y = Math.PI / 2;
		scene.add(leftWall2);
		objects.push(leftWall2);

		var leftWall2 = new THREE.Mesh( geometry, material );
		leftWall2.position.set(x - (depth / 2), height / 2, z); // Middle
		leftWall2.rotation.y = Math.PI / 2;
		scene.add(leftWall2);
		objects.push(leftWall2);
		...
		downWallR1.position.set(x + (depth / 2) - 0.1, 1.5/2, z + wallSize + 25); // First
		...
		downWallR2.position.set(x + (depth / 2) - 0.1,1.5/2, z ); // Middle
		...
		downWallR3.position.set(x + (depth / 2) - 0.1, 1.5/2, z - wallSize - 25 ); // Last
		...
		downWallL1.position.set(x - (depth / 2) + 0.1, 1.5/2, z + wallSize + 25); // First
		...
		downWallL2.position.set(x - (depth / 2) + 0.1, 1.5/2 , z ); // Middle
		...
		downWallL3.position.set(x - (depth / 2) + 0.1, 1.5/2, z - wallSize - 25 ); // Last
		...
		// Posters
		var p1 = new Poster(6.6, 10, x + (depth / 2) - 0.1 , height / 2, ( z + wallSize + 25) - wallSize/4, objects, "textures/sw1.jpg", "R");
		var p2 = new Poster(6.6, 10, x + (depth / 2) - 0.1 , height / 2, ( z + wallSize + 25) + wallSize/4, objects, "textures/sw2.jpg", "R");


		var p3 = new Poster(6.6, 10, x + (depth / 2) - 0.1 , height / 2, z - wallSize/4, objects, "textures/sw5.jpg", "R");
		var p4 = new Poster(6.6, 10, x + (depth / 2) - 0.1 , height / 2, z + wallSize/4, objects, "textures/sw6.jpg", "R");


		var p5 = new Poster(6.6, 10, x + (depth / 2) - 0.1 , height / 2, ( z - wallSize - 25) + wallSize/4, objects, "textures/ro.png", "R");
		var p6 = new Poster(6.6, 10, x - (depth / 2) + 0.1 , height / 2, ( z - wallSize - 25) + wallSize/4, objects, "textures/cw.jpg", "L");


		var p7 = new Poster(6.6, 10, x - (depth / 2) + 0.1 , height / 2, ( z + wallSize + 25) + wallSize/4, objects, "textures/sw3.jpg", "L");
		var p8 = new Poster(6.6, 10, x - (depth / 2) + 0.1 , height / 2, ( z + wallSize + 25) - wallSize/4, objects, "textures/sw4.jpg", "L");


		var p9 = new Poster(6.6, 10, x - (depth / 2) + 0.1 , height / 2, z + wallSize/4, objects, "textures/sw7.jpg", "L");
		var p10 = new Poster(6.6, 10, x - (depth / 2) + 0.1 , height / 2, z - wallSize/4, objects, "textures/sw8.jpg", "L");
